              ...
              <Box key={index}>
                ...
                >
                  <Text
                    ...
                    fontSize={"18px"}
                    variant="ghost"
                    onClick={(e) => handleOptionClick(option.name)}
                    w="100%"
                    color="#f2f2f2"
                    textAlign={"left"}
                    fontWeight={
                      option.name === selectedOption ? "bold" : "normal"
                    }
                  >
                    {option.name}
                  </Text>
                </Box>
                <Collapse in={option.name === selectedOption}>
                        ...
                        ?.subOptions.map((subOption, index) => (
                          <Link key={index} to={"password"}>
                            <Text
                              ...
                              height={"45px"}
                              fontSize="18px"
                              onClick={(e) => handleSubOptionClick(subOption)}
                              key={index}
                              cursor={"pointer"}
                            >
                              {subOption}
