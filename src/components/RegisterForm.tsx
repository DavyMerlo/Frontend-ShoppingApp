                        ...
                        <Form onSubmit={handleSubmit}>
                            <FormControl
                                ...
                                <FormLabel
                                    ...
                                    mb={2}
                                    color={"#f2f2f2"}
                                    fontWeight='bold'>Email</FormLabel>
                                <Input
                                    type="text"
                                    bg={"#000000"}
                                    color={"#f2f2f2"}
                            ...
                            <FormControl
                                ...
                                <FormLabel
                                    ...
                                    mb={2}
                                    color={"#f2f2f2"}
                                    fontWeight='bold'>Password</FormLabel>
                                <Input
                                    type="text"
                                    bg={"#000000"}
                                    fontSize={18}
                            ...
                            <Stack direction={['column', 'row']} spacing={4}>
                                <FormControl
                                    ...
                                    <FormLabel
                                        ...
                                        mb={2}
                                        color={"#f2f2f2"}
                                        fontWeight='bold'>Lastname</FormLabel>
                                    <Input
                                        type="text"
                                        bg={"#000000"}
                                        fontSize={18}
                                ...
                                <FormControl
                                    ...
                                    <FormLabel
                                        ...
                                        mb={2}
                                        color={"#f2f2f2"}
                                        fontWeight='bold'>Firstname</FormLabel>
                                    <Input
                                        type="text"
                                        bg={"#000000"}
                                        fontSize={18}
                            ...
                            <FormControl
                                ...
                                <FormLabel
                                    ...
                                    mb={2}
                                    color={"#f2f2f2"}
                                    fontWeight='bold'>Street</FormLabel>
                                <Input
                                    type="text"
                                    bg={"#000000"}
                                    fontSize={18}
                            ...
                            <FormControl
                                ...
                                <FormLabel
                                    ...
                                    mb={2}
                                    color={"#f2f2f2"}
                                    fontWeight='bold'>City</FormLabel>
                                <Input
                                    type="text"
                                    bg={"#000000"}
                                    fontSize={18}
                            ...
                            <Stack direction={['column', 'row']} spacing={4}>
                                <FormControl
                                    ...
                                    <FormLabel
                                        ...
                                        mb={2}
                                        color={"#f2f2f2"}
                                        fontWeight='bold'>Housenumber</FormLabel>
                                    <Input
                                        type="text"
                                        bg={"#000000"}
                                        fontSize={18}
                                ...
                                <FormControl
                                    ...
                                    <FormLabel mt={2}
                                               mb={2}
                                               color={"#f2f2f2"}
                                               fontWeight='bold'>Busnumber</FormLabel>
                                    <Input
                                        type="text"
                                        bg={"#000000"}
                                        fontSize={18}
                                ...
                                <FormControl
                                    ...
                                    <FormLabel
                                        ...
                                        mb={2}
                                        color={"#f2f2f2"}
                                        fontWeight='bold'>Postalcode</FormLabel>
                                    <Input
                                        type="text"
                                        bg={"#000000"}
                                        fontSize={18}
