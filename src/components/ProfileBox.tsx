      ...
      <Card bg={"#232f3e"} align="start">
        ...
        <CardBody width={"100%"} height={"100%"}>
          <HStack justifyContent={"start"} width={"100%"} height={"100%"}>
            ...
            <Box pl={10} justifyContent={"center"}>
              <Heading>
                <Text color={"#f2f2f2"} fontWeight="bold">
                  {fullName}
                </Text>
              </Heading>
              <Text mt={5} color={"#f2f2f2"} fontSize="lg" fontWeight="bold">
                {street} {houseNumber} {busNumber}
              </Text>
              <Text mt={5} color={"#f2f2f2"} fontSize="lg" fontWeight="bold">
                {postalCode} {localAuthority}
              </Text>
              <Text mt={5} color={"#f2f2f2"} fontSize="lg" fontWeight="bold">
                {user.email}
              </Text>
              <Text mt={5} color={"#f2f2f2"} fontSize="lg" fontWeight="bold">
                Client Number: {user.userName}
              </Text>
            </Box>
          </HStack>
        </CardBody>
        <CardFooter width={"100%"} height={"100%"}>
          <HStack justifyContent={"end"} width={"100%"}>
            <Heading>
              <Text color={"#ff9900"} fontSize="1.0vw">
                New address? Other name? You can adjust that and more here.
              </Text>
            </Heading>
            <Button
              bg={"#000000"}
